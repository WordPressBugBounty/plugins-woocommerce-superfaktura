...
= 1.45.6 =
* Doplnená kontrola v ukladaní názvu spoločnosti v dodacej adrese pri vytváraní objednávky

= 1.45.5 =
* Opravená chyba v ukladaní názvu spoločnosti pri vytváraní objednávky

= 1.45.4 =
* Doplnený filter sf_giftcard_data

= 1.45.3 =
* Zmenené generovanie dobropisov pri refundácii po položkách a doplnená sadzba DPH pri celkovej refundácii

= 1.45.2 =
* Doplnená detekcia sadzby DPH pre poplatky

= 1.45.1 =
* Opravená detekcia sadzby DPH pre poplatky

= 1.45.0 =
* Pridaná podpora prenosu sadzby DPH z pôvodnej objednávky darčekovej karty pri jej uplatnení (WooCommerce Gift Cards)

= 1.44.0 =
* Pridaná možnosť poslať pdf faktúry len v prílohe emailu zákazníkovi

= 1.43.9 =
* Opravená kontrola WooCommerce pri aktivácii pluginu vo WordPress Multisite

= 1.43.8 =
* Doplnená kontrola typu hodnoty atribútu vo formátovaní popisu produktu

= 1.43.7 =
* Zmenená detekcia daňovej sadzby použitej pre dopravu

= 1.43.6 =
* Opravená kontrola existencie dokumentu v SuperFaktúre

= 1.43.5 =
* Opravená chybne vypočítaná cena dopravy pri nastavení WooCommerce na 0 desatinných miest

= 1.43.4 =
* Upravené hľadanie objednávky podľa čísla dokumentu pre databázy s veľkým počom objednávok

= 1.43.3 =
* Odstránený nepotrebný filter pre podporu custom meta vo wc_get_orders()

= 1.43.2 =
* Zmenený spôsob validácie IČ DPH v objednávke

= 1.43.1 =
* Opravená 0% sadzba DPH pre kupón, ktorý zľavou zníži cenu položky na nulu

= 1.43.0 =
* Zmenené spracovanie callbacku automatického párovania a doplnené spracovanie pre úhradu faktúry vzájomným zápočtom pri vystavení dobropisu

= 1.42.6 =
* Pridaná kompatibilita s pluginom Cost Calculator Builder

= 1.42.5 =
* Doplnená prevencia duplicitných requestov pre vytvorenie alebo pregenerovanie faktúry v administrácii

= 1.42.4 =
* Upravená detekcia možných daňových sadzieb pre zľavy
...
= 1.42.0 =
* Pridaný tag [CATEGORY] v popise produktu

= 1.41.8 =
* Odstránené prázdne viacriadkové popisy položiek na faktúre

= 1.41.7 =
* Opravená kompatibilita s pluginom WPify pre iné krajiny ako Slovensko

= 1.41.6 =
* Pridaná možnosť zrušiť filtrami sf_refund_data, sf_shipping_data a sf_discount_data položku z faktúry vrátením null/false

= 1.41.5 =
* Doplnená kontrola existencie pdf pred pridaním do prílohy emailu

= 1.41.4 =
* Opravená sadzba DPH pre kupón s výškou zľavy 100% (aj pre ekvivalent s pevnou výškou zľavy rovnou sume objednávky)

= 1.41.3 =
* Opravená detekcia prenesenia daňovej povinnosti v prípade ak v adrese zákazníka chýba údaj o krajine

= 1.41.2 =
* Doplnená kompatibilita s pluginom WPify (prenášanie IČO, DIČ a IČ DPH z objednávky do dokumentov)

= 1.41.1 =
* Upravené monitorovanie denného počtu SuperFaktúra API requestov

= 1.41.0 =
* Monitorovanie denného počtu SuperFaktúra API requestov a upozornenie na prekročenie limitu

= 1.40.7 =
* Doplnená kontrola WooCommerce pri aktivácii pluginu
